...
face_classifier = cv2.CascadeClassifier(r"D:\FSDS\June (2025)\20th open cv -- practicle\Haarcascades\haarcascade_frontalface_default.xml")
eye_classifier = cv2.CascadeClassifier(r"D:\FSDS\June (2025)\20th open cv -- practicle\Haarcascades\haarcascade_eye.xml")
# Load the image
...
img = cv2.imread(r"D:\DeepLearning\training\happy\face.jpg")
